...
public class comprarCursoPO {
    ...
    @Quando("^pesquisar por \"([^\"]*)\" PO$")
    public void pesquisarPorPO(String curso) {
    ...
    @Entao("^vejo a lista de resultados para o cuso \"([^\"]*)\" PO$")
    public void vejoAListaDeResultadosParaOCusoPO(String curso) {
